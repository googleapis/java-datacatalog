  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "icy.proto\032\032google/iam/v1/policy.proto\032\033google/protobuf/empty.proto\032"
          + " google/protobuf/field_mask.proto\"\343\002\n"
          + "\010Taxonomy\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\031\n"
          + "\014display_name\030\002 \001(\tB\003\340A\002\022\030\n"
          + "\013description\030\003 \001(\tB\003\340A\001\022Z\n"
          + "\026activated_policy_types\030\006"
          + " \003(\01625.google.cloud.datacatalog.v1beta1.Taxonomy.PolicyTypeB\003\340A\001\"J\n"
          + "\n"
          + "PolicyType\022\033\n"
          + "\027POLICY_TYPE_UNSPECIFIED\020\000\022\037\n"
          + "\033FINE_GRAINED_ACCESS_CONTROL\020\001:g\352Ad\n"
          + "#datacatalog.googleapis.com/Taxonomy\022=projects/{project}/locations/{location}/taxonomies/{taxonomy}\"\214\002\n"
          + "\tPolicyTag\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\031\n"
          ...
          + "$datacatalog.googleapis.com/PolicyTag\022Uprojects/{project}/locations/{location}/taxonomies/{taxonomy}/policyTags/{policy_tag}\"\222\001\n"
          ...
          + "\013policy_tags\030\001"
          + " \003(\0132+.google.cloud.datacatalog.v1beta1.PolicyTag\022\027\n"
          + "\017next_page_token\030\002 \001(\t\"Q\n"
          + "\023GetPolicyTagRequest\022:\n"
          + "\004name\030\001 \001(\tB,\340A\002\372A&\n"
          + "$datacatalog.googleapis.com/PolicyTag2\345\026\n"
          + "\020PolicyTagManager\022\316\001\n"
          + "\016CreateTaxonomy\0227.google.cloud.datacatalog.v1bet"
          + "a1.CreateTaxonomyRequest\032*.google.cloud.datacatalog.v1beta1.Taxonomy\"W\202\323\344\223\002?\"3/v1beta1/{parent=projects/*/locations/*}/taxonomies:\010taxonomy\332A\017parent,taxonomy\022\245\001\n"
          + "\016DeleteTaxonomy\0227.google.cloud.datacatalog.v1beta1.DeleteTaxonomyRequest\032\026.google.protobuf.Empty\"B\202\323\344\223\0025*3/v1beta1/{name=projects/*/locations/*/taxonomies/*}\332A\004name\022\320\001\n"
          + "\016UpdateTaxonomy\0227.google.cloud.datacatalog.v1beta1.UpdateTaxonomyRequest\032*.google.cloud.datacatalog.v1beta1.Taxonomy\"Y\202\323\344\223\002H2</v1beta1/{taxonomy.name=projects/*/locations/*/taxonomies/*}:\010taxonomy\332A\010taxonomy\022\311\001\n"
          + "\016ListTaxonomies\0227.google.cloud.datacatalog.v1beta1.ListTaxonomiesRequest\0328.google.cloud.datacatalog.v1beta1.ListTaxonomiesResponse\"D\202\323\344\223\0025\0223/v1beta1/{parent=projects/*/locations/*}/taxonomies\332A\006parent\022\263\001\n"
          + "\013GetTaxonomy\0224.google.cloud.datacatalog.v1beta1.GetTaxonomyRequest\032*.google.cloud.datacatalog.v1beta1.Taxonomy\"B\202\323\344\223\0025\0223/v1beta1/{name=projects/*/locations/*/taxonomies/*}\332A\004name\022\342\001\n"
          + "\017CreatePolicyTag\0228.google.cloud.datacatalog.v1beta1.CreatePolicyTagRequest\032+.google.cloud.datacatalog.v1beta1.PolicyTag\"h\202\323\344\223\002N\"@/v1beta1/{parent=projects/*/locations/*/taxonomies/*}/policyTags:\n"
          + "policy_tag\332A\021parent,policy_tag\022\264\001\n"
          + "\017DeletePolicyTag\0228.google.cloud.datacatalog.v1beta1.DeletePolicyTagRequest\032\026.google.protobuf.Empty\"O\202\323\344\223\002B*@/v1beta1/{name=projects/*/locations/*/taxonomies/*/policyTags/*}\332A\004name\022\346\001\n"
          + "\017UpdatePolicyTag\0228.google.cloud.datacatalog.v1beta1.UpdatePolicyTagRequest\032+.google.cloud.datacatalog.v1beta1.PolicyTag\"l\202\323\344\223\002Y2K/v1beta1/{policy_tag.name=projects/*/locations/*/taxonomies/*/policyTags/*}:\n"
          + "policy_tag\332A\n"
          + "policy_tag\022\326\001\n"
          + "\016ListPolicyTags\0227.google.cloud.datacatalog.v1beta1.ListPolicyTagsRequest\0328.google.cloud.datacatalog.v1beta1.ListPolicyTagsResponse\"Q\202\323\344\223\002B\022@/v1beta1/{parent=projects/*/locations/*/taxonomies/*}/policyTags\332A\006parent\022\303\001\n"
          + "\014GetPolicyTag\0225.google.cloud.datacatalog.v1beta1.GetPolicyTagRequest\032+.google.cloud.datacatalog.v1beta1.PolicyTag\"O\202\323\344\223\002B\022@/v1beta1/{name=projects/*/locations/*/taxonomies/*/policyTags/*}\332A\004name\022\364\001\n"
          + "\014GetIamPolicy\022\".google.iam.v1.GetIamPolicyRequest\032\025.google.iam.v1.Policy\"\250\001\202\323\344\223\002\241\001\"D/v1beta1/{resource=projects/*/locations/*/taxonomies/*}:getIamPolicy:\001*ZV\"Q/v1beta1/{resource=projects/*/locations/*/taxonomies/*/policyTags/*}:getIamPolicy:\001*\022\364\001\n"
          + "\014SetIamPolicy\022\".google.iam.v1.SetIamPolicyRequest\032\025.google.iam.v1.Policy\"\250\001\202\323\344\223\002\241\001\"D/v1beta1/{resource=projects/*/locations/*/taxonomies/*}:setIamPolicy:\001*ZV\"Q/v1beta1/{resource=projects/*/locations/*/taxonomies/*/policyTags/*}:setIamPolicy:\001*\022\240\002\n"
          ...
          + "eta1/{resource=projects/*/locations/*/taxonomies/*}:testIamPermissions:\001*Z\\\"W/v1beta1/{resource=projects/*/locations/*/taxonomies/*/policyTags/*}:testIamPermissions:\001*\032N\312A\032datacatalog.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\373\001\n"
          + "$com.google.cloud.datacatalog.v1beta1B\025PolicyTagManagerProtoP\001ZKgoogl"
          + "e.golang.org/genproto/googleapis/cloud/datacatalog/v1beta1;datacatalog\370\001\001\252\002"
          + " Google.Cloud.DataCatalog.V1Beta1\312\002 Google\\Cl"
          + "oud\\DataCatalog\\V1beta1\352\002#Google::Cloud::DataCatalog::V1beta1b\006proto3"
    };
    descriptor =
