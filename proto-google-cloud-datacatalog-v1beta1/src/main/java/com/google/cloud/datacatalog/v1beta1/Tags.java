  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "/api/resource.proto\032\037google/protobuf/timestamp.proto\"\220\003\n"
          + "\003Tag\022\014\n"
          ...
          + "\036datacatalog.googleapis.com/Tag\022\\projects/{project}/locations/{location}/entryG"
          + "roups/{entry_group}/entries/{entry}/tags/{tag}B\007\n"
          + "\005scope\"\255\002\n"
          + "\010TagField\022\031\n"
          ...
          + "24.google.cloud.datacatalog.v1beta1.TagField.EnumValueH\000\022\022\n"
          ...
          + "ud.datacatalog.v1beta1.TagTemplate.FieldsEntryB\003\340A\002\032a\n"
          + "\013FieldsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022A\n"
          + "\005value\030\002"
          + " \001(\01322.google.cloud.datacatalog.v1beta1.TagTemplateField:\0028\001:p\352Am\n"
          + "&datacatalog.googleapis.com/TagTemplate\022Cpro"
          + "jects/{project}/locations/{location}/tagTemplates/{tag_template}\"\247\002\n"
          ...
          + "tagTemplates/{tag_template}/fields/{field}\"\247\003\n"
          + "\tFieldType\022S\n"
          + "\016primitive_type\030\001 \001(\016"
          + "29.google.cloud.datacatalog.v1beta1.FieldType.PrimitiveTypeH\000\022I\n"
          + "\tenum_type\030\002 \001(\013"
          + "24.google.cloud.datacatalog.v1beta1.FieldType.EnumTypeH\000\032\212\001\n"
          + "\010EnumType\022V\n"
          + "\016allowed_values\030\001"
          + " \003(\0132>.google.cloud.datacatalog.v1beta1.FieldType.EnumType.EnumValue\032&\n"
          + "\tEnumValue\022\031\n"
          ...
          + "\ttype_declB\344\001\n"
          + "$com.google.cloud.datacatalog.v1beta1P\001ZKgoogle."
          + "golang.org/genproto/googleapis/cloud/datacatalog/v1beta1;datacatalog\370\001\001\252\002"
          + " Google.Cloud.DataCatalog.V1Beta1\312\002 Google\\Clou"
          + "d\\DataCatalog\\V1beta1\352\002#Google::Cloud::DataCatalog::V1beta1b\006proto3"
    };
    descriptor =
